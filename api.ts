...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiUserGetqrcommandsGet: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/User/getqrcommands`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @throws {RequiredError}
         */
        apiUserSetpushtokenPost: async (body?: object, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/User/setpushtoken`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const UserApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiUserGetqrcommandsGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await UserApiAxiosParamCreator(configuration).apiUserGetqrcommandsGet(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async apiUserSetpushtokenPost(body?: object, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await UserApiAxiosParamCreator(configuration).apiUserSetpushtokenPost(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiUserGetqrcommandsGet(options?: any): AxiosPromise<void> {
            return UserApiFp(configuration).apiUserGetqrcommandsGet(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} [pair] 
         ...
         * @throws {RequiredError}
         */
        apiUserSetpushtokenPost(body?: object, options?: any): AxiosPromise<void> {
            return UserApiFp(configuration).apiUserSetpushtokenPost(body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} [page] 
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public apiUserGetqrcommandsGet(options?: any) {
        return UserApiFp(this.configuration).apiUserGetqrcommandsGet(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof UserApi
     */
    public apiUserSetpushtokenPost(body?: object, options?: any) {
        return UserApiFp(this.configuration).apiUserSetpushtokenPost(body, options).then((request) => request(this.axios, this.basePath));
    }
